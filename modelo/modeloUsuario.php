...
class ModeloUsuario{
    ...
    function entrar()
    {
    	...
    	$User=$this->param['user'];
    	$password=$this->param['password'];
    	$consultaSql="SELECT u.idUsuario,e.idempresa,e.nombre,u.usu_nick FROM usuario u inner join empresa e on e.idUsuario=u.idUsuario where u.usu_nick='$User' and u.usu_clave='$password' ";
    	$this->result = mysql_query($consultaSql);
